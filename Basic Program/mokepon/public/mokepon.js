...
function unirseAlJuego(){
    fetch("http://work.local:8080/unirse")
        .then(function(res) {
            if (res.ok){
                res.text()
...
function seleccionarMokepon(mascotaJugador){
    fetch(`http://work.local:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques(){
    fetch(`http://work.local:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "content-type": "application/json"
        },
...
function obtenerAtaques(){
    fetch(`http://work.local:8080/mokepon/${enemigoId}/ataques`)
        .then(function(res){
            if (res.ok){
                res.json()
...
function enviarPosicion(x, y){
    fetch(`http://work.local:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "content-type": "application/json"
        },
